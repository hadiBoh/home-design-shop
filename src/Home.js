...
const Home = () => {
  const { data , handleprice} = useContext(DataFetch)
    ...
    <div className="home">
      <section className="intro">
        <div className='intro_left'>
          <h1 className="header intro__header">Design Your Comfort Zone</h1>
          <p className="intro__intro">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. A accusantium nesciunt consequatur animi dolor, ratione atque suscipit sapiente repellat cum.
          </p>
          <button className="btn intro__btn">SHOP NOW</button>
        </div>
        <div className='intro_right'>
          <img className='hero_1' src='./images/hero.jpeg' alt='hero1'/>
          <img className='hero_2' src='./images/hero-2.jpeg' alt='hero2'/>
        </div>
      </section>
      {/* Featured Products */}
      <section className="feature">
        <h2 className="feature__header">Featured Products</h2>
              ...
              return (
                <div className="feature__card" key={item.id}>
                  <div className='img-wrapper'>
                    ...
                    <img src={item.image} alt="decoration" />
                  <Link className='modalbtn' to={`products/${item.id}`} ><i className='bx bx-search-alt-2'></i></Link>
                  </div>
      ...
      <section className='sign__section'>
        <h1 className='sign__header'>Join our newsletter and get 20% off</h1>
        ...
        <div className='sign_input_section'>
          <input className='sign-input' type="text" placeholder='Enter Your Email'></input>
          <button className='sign-btn'>Subscribe</button>
        </div>
      </section>
